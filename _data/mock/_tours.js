...
export const _tours = [...Array(12)].map((_, index) => ({
  ...
  galleryss: _mock.image.allServices(index),
  ...
  location: _mock.address.areas(index),
  ...
  ratings: 4.4 + index / 10,
  tourGuide: {
    name: _mock.name.fullName(index),
    role: _mock.role(index),
    picture: _mock.image.avatar(index),
    gallerys: _mock.image.industrialSteelStructures(index),
    gallery: [...Array(6)].map((_, index) => _mock.image.industrialSteelStructures(index + 0)),
  ...
  gallerys: [...Array(5)].map((_, index) => _mock.image.industrialSteelStructures(index + 0)),
  gallery: _mock.image.industrialSteelStructures(index),
  galleryTwo: _mock.image.industrialSteelStructures(index),
