...
const VISIONS = [
  ...
  { name: 'Компетентность', description: 'Suspendisse feugiat. Quisque id odio.' },
];
      ...
      <Container>
        ...
        >
          ...
          <Typography sx={{ color: 'text.secondary' }}>
            Сохраняя устойчивое развитие достигать новые вершины, реализовывая сложные проекты и расширяя возможности
          </Typography>
        </Stack>
