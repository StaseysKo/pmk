...
export const PageLinks = [
  ...
  },
  {
    ...
    cover: 'https://zone-assets-api.vercel.app/assets/images/menu/menu_travel.jpg',
    items: [
      { title: 'Landing', path: Routes.metal.landing },
      { title: 'All Services', path: Routes.metal.allServices },
      { title: 'Service', path: Routes.metal.service('service-01') },
      { title: 'Checkout', path: Routes.travel.checkout },
      { title: 'Checkout Complete', path: Routes.travel.checkoutComplete },
      { title: 'Blog Posts', path: Routes.travel.posts },
      { title: 'Blog Post', path: Routes.travel.post('post-01') },
...
export const navConfig = [
  { title: 'О компании', path: '/travel/about-us' },
  { title: 'Услуги', path: '/metal/all-services' },
  { title: 'Портфолио', path: '/marketing/case-studies' },
  // {
  //   title: 'Портфолио',
  //   path: Routes.pages,
  //   children: [PageLinks[0], PageLinks[4], PageLinks[1], PageLinks[3], PageLinks[2], PageLinks[5]],
  // },
  { title: 'Партнерам', path: Routes.docs },
  { title: 'Поставщикам', path: '/marketing/about-us' },
  { title: 'Карьера', path: '/career/jobs' },
];
